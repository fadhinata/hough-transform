...
public class CannyEdgeDetector {
	...
	private PlanarImage edgePlanar;
	...
	public void setSourceImage(PlanarImage image) {
		sourceImage = image;
	}
	...
	public PlanarImage getEdgesImage() {
		return edgePlanar;
	}
	 ...
	 */
//	
//	public void setEdgesImage(PlanarImage edgesImage) {
//		this.ed = edgesImage;
//	}
	...
	private void readLuminance() {
		int type = sourceImage.getAsBufferedImage().getType();
	...
	private void writeEdges(int pixels[]) {
		...
		edgesImage.getWritableTile(0, 0).setDataElements(0, 0, width, height, pixels);
		 edgePlanar = PlanarImage.wrapRenderedImage(edgesImage);
	}
